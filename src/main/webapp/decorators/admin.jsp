...
<link rel="stylesheet"
	href='<c:url value="/templates/admin/plugins/datatables-bs4/css/dataTables.bootstrap4.css"/>'>
...
<body class="sidebar-mini sidebar-closed sidebar-collapse"
	...
	<script	src='<c:url value="/templates/admin/plugins/datatables-bs4/js/dataTables.bootstrap4.js"/>'></script>
	<script src='<c:url value="/templates/admin/plugins/bs-custom-file-input/bs-custom-file-input.min.js"/>'></script>
